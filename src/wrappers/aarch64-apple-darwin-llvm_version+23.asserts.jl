# Autogenerated wrapper script for MLIR_jll for aarch64-apple-darwin-llvm_version+23.asserts
...
JLLWrappers.@declare_library_product(libMLIR, "@rpath/libMLIR.23.1jl.dylib")
